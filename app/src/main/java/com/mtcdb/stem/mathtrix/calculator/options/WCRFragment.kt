...
class WorkingCapitalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        currentAssetsEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextCurrentAssets)
        currentLiabilitiesEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextCurrentLiabilities)
        ...
        buttonSolution.setOnClickListener {
            ...
            resultTextView.text = getString(com.calculator.calculatoroptions.R.string.wc_result, workingCapitalRatio)
