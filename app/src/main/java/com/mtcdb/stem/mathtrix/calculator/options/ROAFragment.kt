...
class ROAFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        netIncomeEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextNetIncomeROA)
        averageTotalAssetsEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextAverageTotalAssetsROA)
        calculateButton = view.findViewById(com.calculator.calculatoroptions.R.id.buttonCalculateROA)
        ...
        buttonSolution.setOnClickListener {
            ...
            resultTextView.text = getString(com.calculator.calculatoroptions.R.string.roa_result, returnOnAssets)
