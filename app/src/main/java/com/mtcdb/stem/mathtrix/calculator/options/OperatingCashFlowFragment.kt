...
class OperatingCashFlowRatioFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_operating_cash_flow_ratio, container, false)
        ...
        buttonSolution.setOnClickListener {
            ...
            resultTextView.text =
                getString(com.calculator.calculatoroptions.R.string.operating_cash_flow_ratio_result, operatingCashFlowRatio)
