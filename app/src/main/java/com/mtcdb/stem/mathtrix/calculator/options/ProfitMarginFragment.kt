...
class ProfitMarginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView =
            inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_profit_margin, container, false)

        costPriceEditText = rootView.findViewById(com.calculator.calculatoroptions.R.id.editTextCostPrice)
        ...
        descriptionTextView = rootView.findViewById(com.calculator.calculatoroptions.R.id.tVCalculationOptionDescription)
