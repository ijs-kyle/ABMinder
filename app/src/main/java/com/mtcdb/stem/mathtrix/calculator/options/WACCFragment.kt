...
class WACCFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_wacc, container, false)

        // Initialize UI components
        costOfDebtEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextCostOfDebt)
        costOfEquityEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextCostOfEquity)
        debtWeightEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextDebtWeight)
        equityWeightEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextEquityWeight)
        taxRateEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextTaxRate)
        calculateButton = view.findViewById(com.calculator.calculatoroptions.R.id.buttonCalculateWACC)
        ...
        buttonSolution.setOnClickListener {
            ...
            showExplanationDialog(costOfDebt, costOfEquity, taxRate, v, debtWeight, equityWeight, wacc)
        }
