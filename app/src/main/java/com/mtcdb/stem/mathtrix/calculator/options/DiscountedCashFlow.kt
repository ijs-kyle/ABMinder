...
class DiscountedCashFlowFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_discounted_cash_flow, container, false)

        // Initialize UI components
        initialInvestmentEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextInitialInvestmentDCF)
        cashFlowsEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextCashFlowsDCF)
        discountRateEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextDiscountRateDCF)
        calculateButton = view.findViewById(com.calculator.calculatoroptions.R.id.buttonCalculateDCF)
    ...
    private fun showExplanationDialog(
        ...
        val explanation = """
            ...
            Solution:
                DCF = -$initialInvestment + ${cashFlows.joinToString(" + ") { "(%.2f / (1 + $discountRate)^${cashFlows.indexOf(it) + 1})" }}
