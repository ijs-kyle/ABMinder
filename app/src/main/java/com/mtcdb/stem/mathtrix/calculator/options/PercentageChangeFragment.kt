...
class PercentageChangeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_percentage_change, container, false)

        originalValueEditText = rootView.findViewById(com.calculator.calculatoroptions.R.id.editTextOriginalValue)
        newValueEditText = rootView.findViewById(com.calculator.calculatoroptions.R.id.editTextNewValue)
