...
class DTERFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.calculator.calculatoroptions.R.layout.fragment_dter, container, false)

        // Initialize UI components
        totalDebtEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextTotalDebt)
        equityEditText = view.findViewById(com.calculator.calculatoroptions.R.id.editTextEquity)
        calculateButton = view.findViewById(com.calculator.calculatoroptions.R.id.buttonCalculateDebtToEquityRatio)
    ...
    private fun showExplanationDialog(totalDebt: Double, equity: Double, debtToEquityRatio: Double) {
        val explanation = """
